...
const AppInlineMenu = (props) => {
    ...
    return (
        <div className={inlineMenuClassName} style={props.style}>
            ...
            <button data-test-id="side-menu-user-btn" data-pr-tooltip="Amy Elsner" className={classNames('avatarTooltip layout-inline-menu-action p-link flex flex-row align-items-center', { 'p-3 lg:p-1 py-3': props.horizontal, 'p-3': !props.horizontal })} onClick={(e) => props.onInlineMenuClick(e, menuKey)}>
                ...
                <span className={classNames('flex flex-column', { 'ml-2': !isRTL, 'mr-2': isRTL })}>
                    <span className="font-bold" data-test-id="user-name-text">{currentUser.name} {currentUser.lastname}</span>
                ...
                <>
                    <ul className="layout-inline-menu-action-panel">
                        ...
                        <li className="layout-inline-menu-action-item tooltip" data-pr-tooltip="Logout" >
                            <button data-test-id="side-menu-logout-btn" onClick={logout} className="flex flex-row align-items-center p-link">
