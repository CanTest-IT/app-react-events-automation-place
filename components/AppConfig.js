...
const AppConfig = (props) => {
    ...
    return (
        <>
            <Sidebar appendTo="self" visible={active} onHide={() => setActive(false)} position={'left'} blockScroll={true} showCloseIcon={false} baseZIndex={1000} className="layout-config p-sidebar-sm fs-small p-p-0">
