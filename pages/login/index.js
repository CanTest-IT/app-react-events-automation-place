					...
					<div className="input-panel flex flex-column px-3">
						<div className="p-inputgroup">
							...
							<span className="p-float-label">
								<InputText onChange={e => setUsername(e.target.value)} type="text" id="inputgroup1" data-test-id="username-input" />
						...
						<div className="p-inputgroup mt-3 mb-6">
							...
							<span className="p-float-label">
								<InputText onChange={e => setPassword(e.target.value)} type="password" id="inputgroup2" data-test-id="password-input" />
								<label htmlFor="inputgroup2">Password</label>
							</span>
						</div>
					</div>
					<DynamicButton disabled={loading} onClick={login} className="login-button px-3" label="LOGIN" data-test-id="login-btn"></DynamicButton>
				</div>
			</div>
		</div>
		</>
